...
namespace OnlineShoping.Repositary
{
    public class GenericRepositary<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;

        private OnlineShoppingEntities3 _DBEntity;

        public IEnumerable<Tbl_Entity> Product => throw new NotImplementedException();

        public GenericRepositary(OnlineShoppingEntities3 DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        object IRepository<Tbl_Entity>.GetFirstorDefault()
        {
            throw new NotImplementedException();
        }
    }
